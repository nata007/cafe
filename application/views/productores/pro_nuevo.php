	...
	<?php 
		...
		echo form_open('Productores/nuevo_productor',$attributes);
                              ...
                              <div class="panel-body">
                                  <form role="form">
                                      <div class="form-group">
                                          <label for="exampleInputEmail1">Clave productor</label>
                                          <input type="text" class="form-control" id="cafe_clave" name="cafe_clave"
                                          placeholder="Razon social" maxlength="10" required>
                                      </div>
                                      <div class="form-group">
                                          <label for="exampleInputEmail1">Nombre</label>
                                          <input type="text" class="form-control" id="cafe_nombre" name="cafe_nombre"
                                          placeholder="Nombre completo" maxlength="40" required>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          ...
                                          placeholder="Numero ext" maxlength="6" required>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          ...
                                          placeholder="Fecha de ingreso" maxlength="10" required >
                                      </div>
